...
export default function FREMPage() {
  ...
  return (
    <>
      ...
      <section className="relative bg-gradient-to-br from-orange-900 via-gray-900 to-gray-900 py-24 text-white lg:py-32 overflow-hidden">
        ...
        <div className="container relative z-10">
          <div className="mx-auto max-w-4xl text-center">
            <motion.div
              ...
              className="mb-8 inline-flex items-center gap-3 px-6 py-3 bg-orange-500/20 backdrop-blur-xl border-2 border-orange-400/50 rounded-full"
            ...
            <motion.h1 
              ...
              style={{ textShadow: '0 0 40px rgba(249, 115, 22, 0.8)', lineHeight: '1.2' }}
            >
              {expertise.name}
            </motion.h1>
            ...
            >
              ...
              >
                <Link
                  href="/contact"
                  className="btn-primary inline-flex items-center gap-2 tech-border bg-white text-orange-600 hover:bg-gray-100"
                >
                  Nous contacter
            ...
            >
              <div className="glass-card relative overflow-hidden p-8 tech-border group hover:shadow-2xl transition-shadow mb-8">
                ...
                <div className="space-y-4 relative z-10">
                  {[
                    { icon: Wrench, label: t('pages.common.capacity'), value: expertise.capabilities.capacity },
                    { icon: Target, label: t('pages.common.precision'), value: expertise.capabilities.precision },
                    { icon: Factory, label: t('pages.common.equipment'), value: expertise.capabilities.machines }
                  ].map((cap, idx) => (
                    <motion.div 
                      key={idx}
